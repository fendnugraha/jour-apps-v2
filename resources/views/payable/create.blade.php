    ...
    <div class="container">
        ...
        <form action="/hutang/add" method="post">
            ...
            <div class="mb-2 row">
                ...
                <div class="col-sm-8">
                    <select name="debt_code" class="form-select @error('debt_code') is-invalid @enderror"
                        id="debt-code-payable">
                    ...
                    <div class="form-check mt-2">
                        <input type="checkbox" name="debt_code" id="modal-checkbox-payable" value="30100-001"
                            class="form-check-input">
                        <label for="modal-checkbox-payable" class="form-check-label">Jadikan saldo awal hutang
                            (Modal)</label>
                    </div>
                </div>
            </div>
