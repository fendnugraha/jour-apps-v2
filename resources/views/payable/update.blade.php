                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-8">
                            <input type="datetime-local" class="form-control @error('date_issued') is-invalid @enderror"
                                ...
                                value="{{old('date_issued') == null ? $rcv->date_issued : old('date_issued')}}">
                            @error('date_issued')
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-8">
                            <select name="debt_code" id="debt_code"
                                class="form-select @error('debt_code') is-invalid @enderror">
                                <option value="">Pilih Akun Piutang</option>
                                <option value="{{ $account_trace->debt_code }}" selected>{{ $account_trace->debt_code }}
                                    - {{ $account_trace->debt->acc_name }}</option>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-8">
                            <select name="cred_code" id="cred_code"
                                class="form-select @error('cred_code') is-invalid @enderror">
                                <option value="">Pilih Sumber Dana</option>
                                <option value="{{ $account_trace->cred_code }}" selected>{{ $account_trace->cred_code }}
                                    - {{ $account_trace->cred->acc_name }}</option>
                    ...
                    <div class="mb-1 row">
                        ...
                        <div class="col-sm-8">
                            <select name="contact" id="contact"
                                ...
                                <option value="{{ $ct->id }}" {{old('contact')==$ct->id ? 'selected' : ''}}>{{ $ct->name
                                    }}</option>
                                @endforeach
                            </select>
                            @error('contact')
                    ...
                    <div class="mb-1 row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="description" id="description" cols="30" rows="3"
                                class="form-control @error('description') is-invalid @enderror">{{old('description') == null ? $rcv->description : old('description')}}</textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                <small>{{ $message }}</small>
                            </div>
                    ...
                    <div class="mb-1 row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control @error('amount') is-invalid @enderror"
                                ...
                                value="{{old('amount') == null ? $account_trace->amount : old('amount')}}">
                            @error('amount')
                            <div class="invalid-feedback">
                                <small>{{ $message }}</small>
                            </div>
