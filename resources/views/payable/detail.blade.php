                            ...
                            <form action="/hutang/payment" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="cred_code" id="cred_code"
                                        class="form-select {{ $errors->has('cred_code') ? 'is-invalid' : '' }}">
                                        <option value="">Pilih Akun Debet</option>
                                        @foreach ($rscFund as $ac)
                                        <option value="{{ $ac->acc_code }}" {{ old('cred_code')==$ac->acc_code ?
                                            'selected' : '' }}>{{ $ac->acc_name }} - {{ $ac->acc_code }}</option>
                                        @endforeach
                                    </select>
                                    @error('cred_code')
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        name="amount" id="amount" placeholder="Masukkan jumlah pembayaran"
                                        value="{{ old('amount') }}">
                                    @error('amount')
                                    <div class="invalid-feedback">
                                        <small>{{ $message }}</small>
